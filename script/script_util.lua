...
util.clear_item = function(entity, item_name)
    ...
    entity.remove_item {
        name = item_name,
        count = entity.get_item_count(item_name)
    }
end
...
util.angle = function(position_1, position_2)
    local d_x = (position_2[1] or position_2.x) -
                    (position_1[1] or position_1.x)
    local d_y = (position_2[2] or position_2.y) -
                    (position_1[2] or position_1.y)
